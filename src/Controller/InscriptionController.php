...
use App\Form\ AmisuserRegisterType;
use App\Repository;
...
//      $amis = $repo->findOneBy(['username' => $username]);
//
//
//
...
//     }
     ...
     * @Route("/amis/add", name="addamis")
     */
    public function Addamis(Request $request, ObjectManager $manager )
    {
...
// trouver les donne qui est meme que 'email'
    ...
    $form = $this->createForm(AmisuserRegisterType::class, $user);
